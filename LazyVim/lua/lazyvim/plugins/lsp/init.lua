return {
  -- lspconfig
  {
    ...
    dependencies = {
      { "git@github.com:folke/neoconf.nvim", cmd = "Neoconf", config = true },
      { "git@github.com:folke/neodev.nvim", opts = { experimental = { pathStrict = true } } },
      "git@github.com:mason.nvim",
  ...
  -- formatters
  {
    ...
    event = { "BufReadPre", "BufNewFile" },
    dependencies = { "git@github.com:mason.nvim" },
    opts = function()
