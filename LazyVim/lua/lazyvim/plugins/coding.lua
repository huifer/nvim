return {
  ...
  -- auto pairs
  {
    "git@github.com:echasnovski/mini.pairs",
    event = "VeryLazy",
  ...
  -- comments
  { "git@github.com:JoosepAlviste/nvim-ts-context-commentstring", lazy = true },
  {
    "git@github.com:echasnovski/mini.comment",
    event = "VeryLazy",
    opts = {
      hooks = {
        pre = function()
  ...
  -- better text-objects
  {
    "git@github.com:echasnovski/mini.ai",
    -- keys = {
    --   { "a", mode = { "x", "o" } },
    --   { "i", mode = { "x", "o" } },
    -- },
