return {
  ...
  {
    "git@github.com:echasnovski/mini.indentscope",
  ...
  {
    "git@github.com:SmiteshP/nvim-navic",
    lazy = true,
    init = function()
  ...
  -- icons
  { "git@github.com:nvim-tree/nvim-web-devicons", lazy = true },

  -- ui components
  { "git@github.com:MunifTanjim/nui.nvim", lazy = true },
}
